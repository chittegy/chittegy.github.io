...
In this project, i have learned front-end web development skills by developing a Professional Profile Website and deploying it on `github.io` cloud service. The project I have created has general, non-technical, and technical sections.
...
+ Create and deploy a personal website on GitHub cloud (github.io) as a professional profile with your resume, including your name, headshot, contact information, background, e.g., education, your experiences and skills (25 pts).
 ​
 I have Created a public repository as 'c'
